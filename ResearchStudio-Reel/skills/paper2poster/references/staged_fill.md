...
1. **Measure** — run `check_poster.py slack` and read `verdict.overflowSections` / `sparseSections` / `emptySections` / `suppressSections`, plus `check_poster.py polish` for `FIG/NARROW`.
