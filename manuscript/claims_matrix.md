...
| C2 | In three bounded analyses, the tested text proxies did not validate the corresponding equivalence or dependence claims | `inputs/route_a_plus_negative_evidence_dossier.md`; `gates/C6/results_sentence_level.json`; `gates/C6/results_doc_level.json`; `gates/C6/verdict_v2.md`; `manuscript/stage2_5/descriptive_counts.json` | All text proxies are invalid, or natural dependence is absent |
...
| C10 | The anonymous supplement reproduces selected code paths and invariants; full aggregates still require external raw files with recorded hashes | `data/SOURCE_MANIFEST.json`; `gates/C3/v2_1/analysis_correction.md`; `manuscript/supplement/README.md`; `manuscript/supplement/SUPPLEMENT_MANIFEST.json` | The submission is a self-contained aggregate-data artifact |
